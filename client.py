...
class Exaroton:
    ...
    def get_file_info(self, id: str, path:str = ""):

        _data = self._make_request(f"servers/{id}/files/info/{path}")
        return _data

    def get_config_options(self, id: str, path:str):
        _data = self._make_request(f"servers/{id}/files/config/{path}")
        return _data
